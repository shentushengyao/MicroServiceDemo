package com.spring.boot.common.utils.excel;
...
public class ExportExcelUtil {
    ...
    public static void exportExcel(HttpServletResponse response, String fileName, LinkedHashMap<String, String> headMap, JSONArray dataArray) throws Exception {
        // 告诉浏览器用什么软件可以打开此文件
        ...
        exportExcel(headMap, fileName, dataArray, response.getOutputStream());
    }
     ...
     * @param os        文件输出流
     */
    public static void exportExcel(LinkedHashMap<String, String> headMap, String fileName, JSONArray dataArray, OutputStream os) throws IOException {
