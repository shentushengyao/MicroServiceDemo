 ...
 *
 *****************************************************************/
package com.spring.boot.samples.aop;
...
public class WebControllerAop {
    ...
    @Pointcut("execution(* com.spring.boot.samples.controller..*.*(..))")
     ...
     * @param keys
     */
    @AfterReturning(value = "execution(* com.spring.boot.samples.controller..*.*(..))",returning = "keys")
    public void doAfterReturningAdvice1(JoinPoint joinPoint,Object keys){
    	logger.info("第一个后置返回通知的返回值："+keys);
    }

    @AfterReturning(value = "execution(* com.spring.boot.samples.controller..*.*(..))",returning = "keys",argNames = "keys")
     ...
     */
    @Around("execution(* com.spring.boot.samples.controller..*.testAround*(..))")
