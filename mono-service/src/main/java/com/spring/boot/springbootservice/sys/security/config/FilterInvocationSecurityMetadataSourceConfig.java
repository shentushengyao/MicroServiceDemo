...
public class FilterInvocationSecurityMetadataSourceConfig implements FilterInvocationSecurityMetadataSource {
    ...
    public FilterInvocationSecurityMetadataSourceConfig() {
